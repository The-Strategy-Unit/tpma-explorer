# ui
    ...
    Output
      ...
      <ul>
      <li>view <strong>definitions</strong> for TPMAs related to <a href="https://connect.strategyunitwm.nhs.uk/nhp/project_information/modelling_methodology/activity_mitigators/inpatient_activity_mitigators.html">inpatients</a>, <a href="https://connect.strategyunitwm.nhs.uk/nhp/project_information/modelling_methodology/activity_mitigators/outpatient_activity_mitigators.html">outpatients</a> and <a href="https://connect.strategyunitwm.nhs.uk/nhp/project_information/modelling_methodology/activity_mitigators/ae_activity_mitigators.html">A&amp;E</a> activity types</li>
      ...
      Clicking the link will return you to the app with your choices loaded.</p>
      <p>Make <strong>more space</strong> for selections or visualisations by clicking the:</p>
      <ul>
      <li><strong>expand</strong> buttons to open in fullscreen (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-expand" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M3.646 9.146a.5.5 0 0 1 .708 0L8 12.793l3.646-3.647a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 0-.708m0-2.292a.5.5 0 0 0 .708 0L8 3.207l3.646 3.647a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 0 0 0 .708"/></svg> in the lower-left of visualisations)</li>
      <li><strong>toggle-sidebar</strong> chevron to collapse/expand the whole sidebar (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" class="bi bi-chevron-left " style="height:1em;width:1em;fill:currentColor;vertical-align:-0.125em;" aria-hidden="true" role="img" ><path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"></path></svg> in the upper-left of the sidebar)</li>
      <li><strong>sidebar-width</strong> handle to make more horizontal space in the sidebar (| on the middle-right edge of sidebar)</li>
