      ...
      #ydgabwknrs div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
        ...
        <thead>
          <tr class="gt_col_headings">
            <th class="gt_col_heading gt_columns_bottom_border gt_left" rowspan="1" colspan="1" style="background-color: #EFEFEF; font-weight: bold;" scope="col" id="a::stub">Diagnosis</th>
            <th class="gt_col_heading gt_columns_bottom_border gt_right" rowspan="1" colspan="1" style="background-color: #EFEFEF; font-weight: bold;" scope="col" id="n">Count of Activity (spells)</th>
            <th class="gt_col_heading gt_columns_bottom_border gt_right" rowspan="1" colspan="1" style="background-color: #EFEFEF; font-weight: bold;" scope="col" id="pcnt">% of Total Activity</th>
          </tr>
        </thead>
        <tbody class="gt_table_body">
          <tr><th id="stub_1_1" scope="row" class="gt_row gt_left gt_stub">A</th>
      <td headers="stub_1_1 n" class="gt_row gt_right">100</td>
      <td headers="stub_1_1 pcnt" class="gt_row gt_right">50.0%</td></tr>
          <tr><th id="stub_1_2" scope="row" class="gt_row gt_left gt_stub">B</th>
      <td headers="stub_1_2 n" class="gt_row gt_right">50</td>
      <td headers="stub_1_2 pcnt" class="gt_row gt_right">25.0%</td></tr>
          <tr><th id="stub_1_3" scope="row" class="gt_row gt_left gt_stub">C</th>
      <td headers="stub_1_3 n" class="gt_row gt_right">25</td>
      <td headers="stub_1_3 pcnt" class="gt_row gt_right">12.5%</td></tr>
          <tr><th id="stub_1_4" scope="row" class="gt_row gt_left gt_stub" style="background-color: #FBFBFB; font-weight: bold;">Other</th>
      <td headers="stub_1_4 n" class="gt_row gt_right" style="background-color: #FBFBFB; font-weight: bold;">25</td>
      <td headers="stub_1_4 pcnt" class="gt_row gt_right" style="background-color: #FBFBFB; font-weight: bold;">12.5%</td></tr>
          <tr><th id="grand_summary_stub_1" scope="row" class="gt_row gt_left gt_stub gt_grand_summary_row gt_first_grand_summary_row gt_last_summary_row" style="background-color: #EFEFEF; font-weight: bold;">Total</th>
      <td headers="grand_summary_stub_1 n" class="gt_row gt_right gt_grand_summary_row gt_first_grand_summary_row gt_last_summary_row" style="background-color: #EFEFEF; font-weight: bold;">200</td>
      <td headers="grand_summary_stub_1 pcnt" class="gt_row gt_right gt_grand_summary_row gt_first_grand_summary_row gt_last_summary_row" style="background-color: #EFEFEF; font-weight: bold;">—</td></tr>
        </tbody>
...
# entable_encounters (procedures)
    ...
    Output
      ...
      #ydgabwknrs div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
        ...
        <thead>
          <tr class="gt_col_headings">
            <th class="gt_col_heading gt_columns_bottom_border gt_left" rowspan="1" colspan="1" style="background-color: #EFEFEF; font-weight: bold;" scope="col" id="a::stub">Procedures</th>
            <th class="gt_col_heading gt_columns_bottom_border gt_right" rowspan="1" colspan="1" style="background-color: #EFEFEF; font-weight: bold;" scope="col" id="n">Count of Activity (spells)</th>
            <th class="gt_col_heading gt_columns_bottom_border gt_right" rowspan="1" colspan="1" style="background-color: #EFEFEF; font-weight: bold;" scope="col" id="pcnt">% of Total Activity</th>
          </tr>
        </thead>
